    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          /*{
            path: 'contacts',
            loadChildren: () => import('./pages/apps/contacts/contacts-routing.module')
          },*/
          {
            path: 'calendar',
            loadComponent: () =>
            ...
            path: 'carga-diesel',
            loadComponent: () => import('./pages/apps/carga-diesel/carga-diesel.component').then( (m) => m.CargaDieselComponent),
            data: { toolbarShadowEnabled: false }
          },{
            path: 'operadores',
          ...
          /*{
            path: 'contacts',
            loadComponent: () => import('./pages/apps/contacts/contacts-table/contacts-table.component').then( (m) => m.ContactsTableComponent),
            data: { toolbarShadowEnabled: false }
          },*/
          {
            path: 'help-center',
